...
def create_tab(df=None, df_returning=None):
    ...
    # ==========================================
    # SUB-TAB 2: RETURNING CIRCLE
    # ==========================================
    
    if df_returning is not None:
        ...
        pie_colors = {
            ...
            # Add missing values mapping in case
...
- <b>Expander</b> = Jika kategori fandom sama dengan CF sebelumnya, namun juga ikut masuk atau menbambah fandom
        ...
        # Page size selector (matches master data style)
        ...
        returning_layout = pn.pane.Markdown("*Returning Circle data not found.*")
    ...
    trend_tabs = pn.Tabs(
        ('Fandom Trend', fandom_trend_layout),
